...
@router.get("/summary")
def get_dashboard_summary(userId: str, sessionId: str, mcpSessionId: str):
    print(
        f"Fetching dashboard summary for userId: {userId}, sessionId: {sessionId}, mcpSessionId: {mcpSessionId}"
    )
